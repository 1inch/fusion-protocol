...
const ST1INCH_COMPILER_SETTINGS = JSON.parse(JSON.stringify(DEFAULT_COMPILER_SETTINGS));
ST1INCH_COMPILER_SETTINGS.version = '0.8.23';
...
module.exports = {
    ...
    solidity: {
        compilers: [DEFAULT_COMPILER_SETTINGS, ST1INCH_COMPILER_SETTINGS],
        overrides: {
